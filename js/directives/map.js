...
(function () {
    angular.module('SistersBrewApp').factory('googleMapsService', ['facebookService', '$http', '$document', function (facebookService, $http, $document) {
        ...
        var serviceObj = {
            ...
            sellerLocations: BEERLOCATIONS,
            disableScrollingZoom: function () {
                serviceObj.map.setOptions({ scrollwheel: false, draggable: false });
            },
            enableScrollingZoom: function () {
                serviceObj.map.setOptions({ scrollwheel: true, draggable: true });
            },
            setPosAndZoom: function (lat, long, zoomLevel) {
                var pos = {
                    lat: lat,
                    lng: long
                };
                ...
                this.events.forEach(function (eventLocation) {
                    ...
                    if (eventLocation.place != null && eventLocation.place.location) { //some events dont have a location
                        var marker = new google.maps.Marker({
                            ...
                            zIndex:99999,
                            icon: './imgs/sisterlogoEvents.png'
                        });
